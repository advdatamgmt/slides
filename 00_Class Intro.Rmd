...
- Your classmates
    ...
    - Important though to make sure you can really do both the creative and
      technical components so don't over do it.
...
- Excused absences will be almost always be allowed if you contact the instructor BEFORE
      class with explanation, AFTER only rarely, and only in the case of extraordinary
      circumstances
...
- Each will be a small part of your overall grade (usually ~2-4 modules a week; 10-20
  very short problems total or fewer longer problems), but will be critical 
  for self-assessment
...
- *Brief* proposal (dataset, description of figure & table) due on Oct 29 so that I
  can approve by Nov 5, providing you adequate time to do and turn in by Dec 10.
